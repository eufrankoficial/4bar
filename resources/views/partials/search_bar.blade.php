    ...
    <div class="table-responsive">
        <table class="table table-hover table-custom spacing5">
            ...
            <tr>
                ...
                <td>
                    <div class="d-flex align-items-center">
                        <img data-toggle="tooltip" src="{{ asset('assets/core/images/xs/avatar2.jpg') }}" data-placement="top" title="" alt="Avatar" class="w35 h35 rounded" data-original-title="Avatar Name">
                        <div class="ml-3">
            ...
            <tr>
                ...
                <td>
                    <div class="d-flex align-items-center">
                        <img data-toggle="tooltip" src="{{ asset('assets/core/images/xs/avatar5.jpg') }}" data-placement="top" title="" alt="Avatar" class="w35 h35 rounded" data-original-title="Avatar Name">
                        <div class="ml-3">
            ...
            <tr>
                ...
                <td>
                    <div class="d-flex align-items-center">
                        <img data-toggle="tooltip" src="{{ asset('assets/core/images/xs/avatar6.jpg') }}" data-placement="top" title="" alt="Avatar" class="w35 h35 rounded" data-original-title="Avatar Name">
                        <div class="ml-3">
